...
const ParticleCard = ({
  ...
  useEffect(() => {
    ...
    element.addEventListener('click', handleLocalClick);
    ...
    return () => {
      ...
      element.removeEventListener('click', handleLocalClick);
      clearAllParticles();
    };
      ...
      <div className="card-grid bento-section" ref={gridRef}>
        {projects.map((project, index) => {
            ...
            return (
              ...
              >
                <div className="magic-bento-card__header">
                  <div className="magic-bento-card__label" style={{ color: 'var(--finna-primary)' }}>
                    {project.date}
                  </div>
                </div>
                <div className="magic-bento-card__content">
                  <h2 className="magic-bento-card__title">{project.id}</h2>
                  <p className="magic-bento-card__description">
                    {project.desc || 'No descriptive ledger found for this module log.'}
                  </p>
                </div>
              </ParticleCard>
            );
          ...
          return (
            ...
            >
              <div className="magic-bento-card__header">
                <div className="magic-bento-card__label" style={{ color: 'var(--finna-primary)' }}>{project.date}</div>
              </div>
              <div className="magic-bento-card__content">
                <h2 className="magic-bento-card__title">{project.id}</h2>
                <p className="magic-bento-card__description">{project.desc}</p>
              </div>
            </div>
          );
        })}
